...
void process_tuple(Tuple *t){
    ...
    switch (key) {
    	...
    	case APP_KEY_SHOW_DATE:
            data_framework_local_settings.show_date = value;
            break;
        case APP_KEY_ALT_DATE_FORMAT:
            data_framework_local_settings.alt_date_format = value;
            break;
        #ifdef PBL_COLOR
    	...
    	case APP_KEY_DATE_COLOUR:
            data_framework_local_settings.date_colour = GColorFromHEX(data_framework_hex_string_to_uint(t->value->cstring));
            break;
    	case APP_KEY_BACKGROUND_COLOUR:
            ...
            break;
        case APP_KEY_BATTERY_MODE:
            data_framework_local_settings.battery_mode = value;
            break;
        #endif
    }
}
...
Settings data_framework_get_default_settings(){
	...
	defaults.alt_date_format = true;
	defaults.time_colour = GColorWhite;
	defaults.date_colour = GColorWhite;
	defaults.background_colour = GColorBlack;
    defaults.battery_mode = BATTERY_MODE_BAR_ONLY;
