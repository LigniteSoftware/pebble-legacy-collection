...
typedef enum AppKey {
	...
	APP_KEY_BTREALERT,
    APP_KEY_WEEK_NUMBER,
    APP_KEY_SECOND_RADIAL,
    APP_KEY_SECOND_RADIAL_COLOUR,
    APP_KEY_HOUR_RADIAL,
    APP_KEY_HOUR_RADIAL_COLOUR,
    APP_KEY_MINUTE_RADIAL,
    APP_KEY_MINUTE_RADIAL_COLOUR,
    APP_KEY_BATTERY_RADIAL,
    APP_KEY_BATTERY_RADIAL_COLOUR,
    APP_KEY_BLUETOOTH_ICON_COLOUR,
