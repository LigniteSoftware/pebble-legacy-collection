...
void process_tuple(Tuple *t){
    ...
    switch (key) {
        ...
        case APP_KEY_BTREALERT:
            ...
            break;
        case APP_KEY_BRANCH_WIDTH:
            data_framework_local_settings.width = value;
            break;
        case APP_KEY_RANDOMIZE_BRANCH_COLOUR:
            data_framework_local_settings.randomize_colour = value;
            break;
        ...
        #ifdef PBL_COLOR
        case APP_KEY_CUSTOM_COLOUR_1:
        case APP_KEY_CUSTOM_COLOUR_2:
        case APP_KEY_CUSTOM_COLOUR_3:
            data_framework_local_settings.custom_colour[key-APP_KEY_CUSTOM_COLOUR_1] = GColorFromHEX(data_framework_hex_string_to_uint(t->value->cstring));
            break;
        case APP_KEY_CIRCLE_COLOUR:
            data_framework_local_settings.circle_colour = GColorFromHEX(data_framework_hex_string_to_uint(t->value->cstring));
            break;
        case APP_KEY_TIME_COLOUR:
            data_framework_local_settings.time_colour = GColorFromHEX(data_framework_hex_string_to_uint(t->value->cstring));
            break;
        #endif
    }
}
...
Settings data_framework_get_default_settings(){
    ...
    defaults.randomize_colour = true;
    defaults.width = 2;
    for(int i = 0; i < 3; i++){
        defaults.custom_colour[i] = GColorWhite;
    }
    defaults.circle_colour = GColorBlack;
    defaults.time_colour = GColorWhite;
...
Settings data_framework_port_user_from_settings_1(){
    ...
    newSettings.randomize_colour = oldSettings.randomize_colour;
    newSettings.width = oldSettings.width;
    for(int i = 0; i < 3; i++){
        newSettings.custom_colour[i] = oldSettings.custom_colour[i];
    }
    newSettings.circle_colour = oldSettings.circle_colour;
    newSettings.time_colour = oldSettings.time_colour;
