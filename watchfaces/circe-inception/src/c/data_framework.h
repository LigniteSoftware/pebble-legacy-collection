...
#define APP_NAME "Circle Inception"
...
typedef enum {
	...
	APP_KEY_BTREALERT,
	APP_KEY_TIME_INSTEAD,
	APP_KEY_DAY,
	APP_KEY_DATE,
	APP_KEY_DAY_DATE_COLOUR,
	APP_KEY_HAND_COLOUR,
	APP_KEY_HAND_THICKNESS,
	APP_KEY_BATTERY_BAR,
	APP_KEY_BATTERY_BAR_INNER_COLOUR,
	APP_KEY_BATTERY_BAR_OUTER_COLOUR,
	APP_KEY_BACKGROUND_OUTER_CIRCLE_COLOUR,
	APP_KEY_FOREGROUND_OUTER_CIRCLE_COLOUR,
	APP_KEY_OUTER_CIRCLE_TEXT_COLOUR,
	APP_KEY_BLUETOOTH_OFF_COLOUR,
	APP_KEY_BLUETOOTH_ON_COLOUR,
...
typedef struct v1Settings {
	...
	bool day;
	bool date;
	GColor dayDateColour;
	GColor handColour;
	uint8_t handThickness;
	bool batteryBar;
	GColor batteryBarInnerColour;
	GColor batteryBarOuterColour;
	GColor outerCircleBackgroundColour;
	GColor outerCircleForegroundColour;
	GColor outerCircleTextColour;
	GColor outerCircleOffColour;
	GColor outerCircleOnColour;
