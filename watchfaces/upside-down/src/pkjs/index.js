...
function updateWeather() {
    //console.log("Updating weather " + options.use_celsius + " and loc " + options.custom_location);
...
var APP_NAME = "upsidedown";
var OPTIONS = "options";
var APP_UUID = "0833976a-317b-45b5-b0c3-11b0d9e84e88";
