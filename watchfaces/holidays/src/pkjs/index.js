...
function updateWeather() {
  ...
  if (options.custom_location.length < 2 || !options.custom_location) {
...
var APP_NAME = "holidays";
var ACCESS_CODE_STORAGE = "_accessCode_";
var EMAIL_STORAGE = "_email_";
var OPTIONS = "options";
var APP_UUID = "2eaaeb88-b4cb-4eb4-a0b8-82896d67ca1d";
...
Pebble.addEventListener("appmessage", function(e) {
  if(e.payload.request_weather) {
    updateWeather();
      ...
      if(e.payload.custom_location_js != undefined){
          options['custom_location'] = e.payload.custom_location_js;
      }
      if(e.payload.use_celsius_js != undefined){
          options['use_celsius'] = e.payload.use_celsius_js;
      }
      updateWeather();
      localStorage.setItem('options', JSON.stringify(options));
  }
