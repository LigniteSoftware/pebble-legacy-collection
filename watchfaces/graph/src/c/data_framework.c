...
void process_tuple(Tuple *t){
    ...
    switch (key) {
        ...
        case APP_KEY_BTDISALERT:
            ...
            break;
        case APP_KEY_TOP_TIME:
            data_framework_local_settings.topTime = value;
            break;
        case APP_KEY_DATE:
            data_framework_local_settings.date = value;
            break;
        case APP_KEY_BATTERY_PERCENTAGE:
            data_framework_local_settings.batteryBar = value;
            break;
        case APP_KEY_HOUR:
            data_framework_local_settings.hourBar = value;
            break;
        case APP_KEY_MINUTE:
            data_framework_local_settings.minuteBar = value;
            break;
...
Settings data_framework_get_default_settings(){
    ...
    defaults.topTime = true;
    defaults.date = true;
    defaults.batteryBar = true;
    defaults.minuteBar = true;
    defaults.hourBar = true;
