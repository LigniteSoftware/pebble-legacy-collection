var settingsJSON = {
    ...
    "items": [{
        ...
        "items": [{
            ...
            "storage_key": "mod_btdisalert",
            "pebble_key": 0,
            "default": true
        }, {
            "type": "toggle",
            "label": "pref_btrealert",
            "storage_key": "mod_btrealert",
            "pebble_key": 1,
            "default": false
        }]
    }, {
        ...
        "items": [{
            ...
            "type": "colour",
            "label": "accent_colour",
            "storage_key": "mod_accent_colour_top",
            "pebble_key": 3,
        ...
        "items": [{
            "type": "list",
            "label": "data_type",
            "storage_key": "mod_data_type_right",
            "pebble_key": 4,
            "list": [
                "hidden",
                "health_type_step_count",
            ...
            "type": "colour",
            "label": "accent_colour",
            "storage_key": "mod_accent_colour_right",
            "pebble_key": 5,
            "default": "GColorLightGray"
        }]
    }, {
        ...
        "items": [{
            "type": "list",
            "label": "data_type",
            "storage_key": "mod_data_type_bottom",
            "pebble_key": 6,
            "list": [
                "hidden",
                "health_type_step_count",
            ...
            "type": "colour",
            "label": "accent_colour",
            "storage_key": "mod_accent_colour_bottom",
            "pebble_key": 7,
            "default": "GColorLightGray"
        }]
    }, {
        ...
        "items": [{
            "type": "list",
            "label": "data_type",
            "storage_key": "mod_data_type_left",
            "pebble_key": 8,
            "list": [
                "hidden",
                "health_type_step_count",
            ...
            "type": "colour",
            "label": "accent_colour",
            "storage_key": "mod_accent_colour_left",
            "pebble_key": 9,
            "default": "GColorLightGray"
        }]
    }, {
        ...
        "items": [{
            ...
            "storage_key": "mod_background_colour",
            "pebble_key": 10,
            "default": "GColorBlack"
        }, {
            "type": "colour",
            "label": "outer_circle_colour",
            "storage_key": "mod_outer_circle_colour",
            "pebble_key": 13,
            "default": "GColorRed"
        }, {
            "type": "colour",
            "label": "outer_circle_background_colour",
            "storage_key": "mod_outer_circle_background_colour",
            "pebble_key": 22,
        ...
        "items":[
            {
                ...
                "storage_key": "mod_analogue_hands",
                "pebble_key": 14,
                "default": true
            }, {
                "type": "toggle",
                "label": "hour_hand",
                "storage_key": "mod_hour_hand",
                "pebble_key": 23,
                "default": true
            }, {
                "type": "colour",
                "label": "hour_hand_colour",
                "storage_key": "mod_hour_hand_colour",
                "pebble_key": 11,
                "default": "GColorWhite"
            }, {
                "type": "toggle",
                "label": "minute_hand",
                "storage_key": "mod_minute_hand",
                "pebble_key": 24,
                "default": true
            }, {
                "type": "colour",
                "label": "minute_hand_colour",
                "storage_key": "mod_minute_hand_colour",
                "pebble_key": 12,
                "default": "GColorRed"
            }, {
                "type": "toggle",
                "label": "second_hand",
                "storage_key": "mod_second_hand",
                "pebble_key": 15,
                "default": false
            }, {
                "type": "colour",
                "label": "second_hand_colour",
                "storage_key": "mod_second_hand_colour",
                "pebble_key": 21,
                "default": "GColorWhite"
            }, {
                "type": "toggle",
                "label": "shake_to_hide_hands",
                "storage_key": "mod_shake_to_hide_hands",
                "pebble_key": 19,
                "default": false
            }
        ]
        ...
        "items": [{
            ...
            "storage_key": "mod_imperial_measurements",
            "pebble_key": 20,
            "default": false
        }, {
            "type": "list",
            "label": "outer_circle_type",
            "storage_key": "mod_outer_circle_type",
            "pebble_key": 16,
            "list": [
